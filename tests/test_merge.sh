...
python run.py kitchen_lambchop.pddl lambchop.pddl -o obj_lambchop.pddl -v 0 -e 'experiments/domain_merge' -t 20
...
python run.py kitchen_lambchop.pddl lambchop.pddl -o obj_lambchop.pddl -v 0 -e 'experiments/domain_merge' -po 'lama' -t 20
python run.py "grocery_costs.pddl+kitchen_lambchop.pddl" omelette_lambchop.pddl -o "obj_grocery_costs.pddl+obj_lambchop2.pddl" -v 1 -e 'experiments/domain_merge' -t 60 -po 'lama'

python tests/post_experiments.py experiments/domain_merge -sh tests/test_merge.sh -r