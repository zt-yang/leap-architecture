...
# python run.py kitchen_egg_5.pddl omelette.pddl -o obj_egg_4.pddl -v 0 -e 'experiments/egg_recipes' -g 'is-buttery' # 7s
...
python run.py kitchen_egg_4.pddl scrambled_eggs.pddl -o obj_egg_4.pddl -v 0 -e 'experiments/egg_recipes' # 41s
python run.py kitchen_egg_5.pddl scrambled_eggs.pddl -o obj_egg_4.pddl -v 0 -e 'experiments/egg_recipes' -t 300 ## FAIL
# python run.py kitchen_egg_5.pddl scrambled_eggs.pddl -o obj_egg_4.pddl -v 0 -e 'experiments/egg_recipes' -g 'is-buttery' # 3s
...
python run.py kitchen_egg_4.pddl egg_in_hole.pddl -o obj_egg_4.pddl -v 0 -e 'experiments/egg_recipes' # 3s
python run.py kitchen_egg_5.pddl egg_in_hole.pddl -o obj_egg_4.pddl -v 0 -e 'experiments/egg_recipes' -t 300 ## FAIL
# python run.py kitchen_egg_5.pddl egg_in_hole.pddl -o obj_egg_4.pddl -v 0 -e 'experiments/egg_recipes' -t 300 -g 'is-buttery' # 108s/120s
