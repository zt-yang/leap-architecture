(define (domain Kitchen)
  ...
  ( :derived ( enable-scrambled-eggs ?egg1 - egg ?plate1 - plate )
    ( and 
      ( inside ?plate1 ?egg1 )
      ( beaten ?egg1 )
      ( fried ?egg1 )
  ...
  ( :derived ( enable-omelette ?egg1 - egg ?veggies1 - ingredient ?plate1 - plate )
    ( and 
      ( inside ?plate1 ?egg1 )
        ( beaten ?egg1 )
        ( fried ?egg1 )
  ...
  ( :derived ( enable-egg-in-hole ?egg1 - egg ?bread1 - bread ?plate1 - plate )
    ( and 
  ...
  ( :derived ( enable-poached-egg ?egg1 - egg ?plate1 - plate )
    ( and 
      ( boiled water )
      ( boiled ?egg1 )
